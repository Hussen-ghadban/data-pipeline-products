    ...
    def fetch_data(self,keyword):
        try:
            ...
            with sync_playwright() as p:
                ...
                products = page.query_selector_all('.widget.prod_item-2020.ctr-track-list.show_similar.hasReport')[:10] # Product selector
                ...
                for product in products:
                    ...
                    image_element =product.query_selector('.prod-img').get_attribute('src')
